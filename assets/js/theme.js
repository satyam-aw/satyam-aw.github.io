...
// If no explicit preference is stored, this function returns null and the system
...
// Determine the computed theme, which can be "dark" or "light". If no explicit theme is
// stored, the computed theme follows the user's system preference.
